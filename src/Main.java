...
public class Main {
    ...
    /**
     * Получить сартовый индекс из матрицы от которого будут происходить вычисления сетевого графа (первая вершина из которой выходят все дуги)
    ...
    /**
     * Получить конечный индекс из матрицы до которого будут происходить вычисления сетевого графа (первая вершина в которую выходят все дуги)
     * @param matrix исходный массив вершин ввиде матрицы
